 ...
 * @author vcaruncho
 */
public class Nomatriculados extends ActionSupport {

    private int npage = 0;
    private int anterior = -1;
    private int posterior = -1;
    private ArrayList<Usuario> listanomatriculados;
    private int idasignatura;
    private String nombre;

    public Nomatriculados() {
    }
    ...
    public ArrayList<Usuario> getListamatriculados() throws NamingException, Exception {
        ...
        anterior = npage - 1;
        posterior = npage + 1;
        listanomatriculados = new ArrayList<>();
        int contadorEltos = 0;
