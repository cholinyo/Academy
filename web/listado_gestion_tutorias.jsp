                ...
                <table class="table table-striped">
                    ...
                    <th>Opcion</th>
                        ...
                        <tr>
                            ...
                            <td><s:property value="idalumno"></s:property></td>
                            <td><s:property value="dia"></s:property></td>
                            <td><s:property value="hora"></s:property></td>
                            <td><s:property value="estado"></s:property></td>
                            <td><a href="<s:url action="actiualizatutorias" includeParams="get">
                                       <s:param name="idusuario" value="%{#session.idusuario}"></s:param>
                                       <s:param name="login" value="%{#session.login}"></s:param>
                                       <s:param name="estado" >aceptada</s:param>
                                       <s:param name="idtutoria" value="idtutoria"></s:param>                                  
                                   </s:url>">Aceptar</a></td>
                            <td><a href="<s:url action="actiualizatutorias" includeParams="get">
                                       <s:param name="idusuario" value="%{#session.idusuario}"></s:param>
                                       <s:param name="login" value="%{#session.login}"></s:param>
                                       <s:param name="estado" >rechazada</s:param>
                                       <s:param name="idtutoria" value="idtutoria"></s:param>
                                   </s:url>">Rechazar</a></td>      
                            </s:iterator>    
                </table>
